...
import tasksReadmeTasks from '../docs/02.tasks/01.README_tasks.md';
import tasksGitTasks from '../docs/02.tasks/02.gitTasks.md';
import tasksArrayTasks from '../docs/02.tasks/03.arrayTasks.md';
...
export default [
  ...
  { title: 'Базовые задачи', id: 'folder_02.tasks_13', type: 'folder' },
  {
    appRoute: '02-tasks/01-readme-tasks',
    folderName: '02.tasks',
    folderId: 'folder_02.tasks_13',
    fileName: '01.README_tasks',
    fileUrl: tasksReadmeTasks,
    title: 'README базовые задачи',
    nestLevel: 1,
    id: '14',
    type: 'file',
  },
  {
    appRoute: '02-tasks/02-git-tasks',
    folderName: '02.tasks',
    folderId: 'folder_02.tasks_13',
    fileName: '02.gitTasks',
    fileUrl: tasksGitTasks,
    title: 'Общие задания',
    nestLevel: 1,
    id: '15',
    type: 'file',
  ...
  {
    appRoute: '02-tasks/03-array-tasks',
    folderName: '02.tasks',
    folderId: 'folder_02.tasks_13',
    fileName: '03.arrayTasks',
    fileUrl: tasksArrayTasks,
    title: 'Задачи на методы массивов и рекурсию',
    nestLevel: 1,
    id: '16',
    type: 'file',
  },
  { title: 'Для ментора', id: 'folder_03.forMentor_17', type: 'folder' },
  {
    appRoute: '03-for-mentor/01-readme-for-mentor',
    folderName: '03.forMentor',
    folderId: 'folder_03.forMentor_17',
