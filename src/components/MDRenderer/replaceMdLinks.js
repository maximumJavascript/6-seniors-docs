...
// FIXME: duplicate code from scripts/
// не смог понять как commonJS подружить с ESModule
export default function replaceMdLinks(mdContent, mdDocsFilesData, options) {
